...
<body>
    <h1 class="title">Modifica Presenza</h1>
...
<form method="post" action="index.php?action=modifica" onsubmit='return controlloore()'>
    <div class="input-row">
        ...
        <input type="time" name="inizio_turno" id="inizio_turno" value="<?=$change['inizio_turno']?>" required>
    </div>
    <div class="input-row">
        <label for="fine_turno">Orario fine turno:</label>
        <input type="time" name="fine_turno" id="fine_turno" value="<?=$change['fine_turno']?>" required>
    </div>
    <div class="input-row">
        <label for="giorno">Data:</label>
        <input type="date" name="giorno" id="giorno" value="<?=$change['giorno']?>" required>
    </div>
    <div class="input-row">
        <label for="descrizione">Descrizione:</label>
        <input type="text" name="descrizione" id="descrizione" value="<?=$change['descrizione']?>" required>
    </div>
    <div class="input-row-inline">
        <input type="checkbox" id="entrata" onclick="myentrata()">
        <label for="entrata">Entrata:</label>
        <input type="time" name="entrata" id="input_entrata" value="<?=$change['entrata']?>" disabled>
    </div>
    <div class="input-row-inline">
        <input type="checkbox" id="uscita" onclick="myuscita()">
        <label for="uscita"> Uscita : </label>
        <input type="time" name="uscita" id="input_uscita" value="<?=$change['uscita']?>" disabled>
    </div>
