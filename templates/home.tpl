...
<body>
<h1> Ciao <?=$_SESSION['user']['nome']?></h1>
<table>
<thead>
<tr><th>Giorno</th><th>Inizio_turno</th><th> Fine_turno</th><th> Entrata </th> <th> Uscita </th> <th> descrizione </th></tr>
...
<button><a href="index.php?action=insert">Aggiungi</a></button>
